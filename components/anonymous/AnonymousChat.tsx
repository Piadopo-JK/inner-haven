...
import { ArrowLeft, SendHorizonal, UserRound } from "lucide-react";
  ...
  return (
    <div className={`flex ${mine ? "justify-end" : "justify-start"}`}>
      <div
        ...
        style={{
          background: mine ? "var(--msg-bubble-own-bg)" : "var(--msg-bubble-peer-bg)",
          color: mine ? "var(--msg-bubble-own-text)" : "var(--msg-bubble-peer-text)",
        }}
      >
  ...
  return (
    <div className="space-y-0.5">
      <div className="flex items-center gap-2 px-2 py-1">
        <span className="h-px flex-1" style={{ background: "var(--msg-divider-line-color)" }} />
        <span
          className="text-[10px] tracking-wide"
          style={{ color: "var(--msg-timestamp-color)" }}
        >
  ...
  return (
    ...
    >
      <div className="flex shrink-0 items-center gap-3 border-b px-4 py-3"
        style={{
          borderColor: "var(--msg-inner-border)",
          background: "var(--msg-chat-header-bg)",
        }}
      >
        {onBack ? (
          <button
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-xs" style={{ color: "var(--msg-timestamp-color)" }}>
            {sender === "student"
      ...
      <div className="flex shrink-0 items-center gap-3 px-4 pt-3">
        ...
        <span
          ...
          style={{ color: "var(--msg-divider-text-color)" }}
        >
          {dateLabel}
        </span>
        <span className="h-px flex-1" style={{ background: "var(--msg-divider-line-color)" }} />
      ...
      {sender === "counselor" && isDetached ? (
        <div className="shrink-0 border-t p-4 text-center text-sm"
          style={{
            ...
            boxShadow: "var(--msg-input-bar-shadow)",
          }}
        >
        ...
        >
          ...
          <div className="flex items-center gap-2">
            <div
              className="flex flex-1 items-center rounded-xl border px-4"
              style={{
